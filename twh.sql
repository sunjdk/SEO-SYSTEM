...
INSERT INTO `cmf_auth_rule` VALUES ('174', 'Seo', 'admin_url', 'seo/adminseo/default', null, 'seo报表管理', '1', '');
INSERT INTO `cmf_auth_rule` VALUES ('175', 'Seo', 'admin_url', 'seo/adminseo/add', null, '添加数据', '1', '');
INSERT INTO `cmf_auth_rule` VALUES ('176', 'Seo', 'admin_url', 'seo/adminseo/index', null, '报表列表', '1', '');
...
INSERT INTO `cmf_menu` VALUES ('187', '0', 'Seo', 'AdminSeo', 'default', '', '1', '1', 'seo报表管理', '', 'seo报表管理模块', '50');
INSERT INTO `cmf_menu` VALUES ('188', '187', 'Seo', 'AdminSeo', 'add', '', '1', '1', '添加数据', '', '添加数据', '0');
INSERT INTO `cmf_menu` VALUES ('189', '187', 'Seo', 'AdminSeo', 'index', '', '1', '1', '报表列表', '', '报表列表,展示所有用户报表', '0');
...
INSERT INTO `cmf_options` VALUES ('6', 'site_options', '            {\n            		\"site_name\":\"twh.io\",\n            		\"site_host\":\"http://twh.io/\",\n            		\"site_root\":\"\",\n            		\"site_icp\":\"\",\n            		\"site_admin_email\":\"1620016116@qq.com\",\n            		\"site_tongji\":\"\",\n            		\"site_copyright\":\"\",\n            		\"site_seo_title\":\"twh.io\",\n            		\"site_seo_keywords\":\"twh\",\n            		\"site_seo_description\":\"twh\"\n        }', '1');
...
CREATE TABLE `cmf_seo` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `client` char(30) DEFAULT '' COMMENT '客户姓名',
  `bword` int(11) DEFAULT '0' COMMENT '百度词',
  `pword` int(11) DEFAULT '0' COMMENT '手机百度词',
  `sword` int(11) DEFAULT '0' COMMENT '360 so 排名',
  `gword` int(11) DEFAULT NULL COMMENT '搜狗排名',
  `cdate` char(60) DEFAULT NULL,
  `excel` varchar(80) DEFAULT NULL COMMENT 'excel 表格路径',
  `collect` int(11) unsigned DEFAULT NULL COMMENT '检测到的总关键词数',
  PRIMARY KEY (`id`)
...
-- Records of cmf_seo
-- ----------------------------
INSERT INTO `cmf_seo` VALUES ('1', '河南网赢快车网络技术有限公司', '111', '222', '333', '741', '2018-03-23 04:59', './Uploads/20180323/5ab41993ef8e5.xls', '12889');
INSERT INTO `cmf_seo` VALUES ('2', '钱百万', '1111', '2222', '3333', '852', '2018-03-23 05:02', './Uploads/20180323/5ab419fb7b9cb.xls', '362');
INSERT INTO `cmf_seo` VALUES ('3', '袁百万', '1111', '2222', '3333', '963', '2018-03-23 05:30', './Uploads/20180323/5ab42079e8484.xls', '424522');
INSERT INTO `cmf_seo` VALUES ('4', '丁百万', '111', '222', '333', '357', '2018-03-23 05:42', './Uploads/2018-03-23/5ab4242f3ac7c.xls', '453434');
INSERT INTO `cmf_seo` VALUES ('5', '李百万', '1111', '222', '333', '951', '2018-03-23 05:47', './Uploads/20180323/5ab4248057ae2.xls', '45343453');
INSERT INTO `cmf_seo` VALUES ('6', '赵百万', '111', '222', '333', '743', '2018-03-23 05:50', './Uploads/20180323/2018011616272149583.xls', '7858558');
INSERT INTO `cmf_seo` VALUES ('7', '通天塔', '111', '111', '111', '961', '2018-03-23 06:42', './Uploads/20180323/5ab43146aa0c9.xls', '1727278527');
INSERT INTO `cmf_seo` VALUES ('8', '顶顶顶顶', '111', '222', '333', '458', '2018-03-23 06:43', './Uploads/20180323/5ab431932dc73.xls', '12888');
INSERT INTO `cmf_seo` VALUES ('9', '陶百万', '121', '232', '343', '454', '2018-03-24 21:49', './Uploads/20180324/5ab657a96c6af.xls', '1561351');
...
-- ----------------------------
INSERT INTO `cmf_users` VALUES ('1', 'admin', '###85420a4fada7d7ee07572d58ccf0aaf5', 'admin', '1620016116@qq.com', '', null, '0', '2000-01-01', null, '127.0.0.1', '2018-03-24 21:49:16', '2018-03-20 11:43:54', '', '1', '0', '1', '0', '');
